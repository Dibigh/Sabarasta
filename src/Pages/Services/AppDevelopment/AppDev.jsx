...
import blueLine from '../../../Logo/blueLine.svg';
...
function buttonPressed()
    ...
    <div className={styles.bodyContainer}>
        ...
        <h1>App <span className={styles.UnderlineText}>Development<img className={styles.underLine} src={blueLine} alt='GreenLine'/></span></h1>
        <div className = {styles.introText}>
            <p>Bring Your Vision to Life with Innovative App Development</p>
            <p>Mobile applications are revolutionizing the way businesses connect with customers, driving engagement, and enhancing user</p>   
            <p>experiences. Sabrasta creates intuitive, secure, and scalable apps tailored to your business needs, helping you stay ahead in today’s </p>
            <p>fast-paced digital environment.</p><img src={bubbles} className={styles.bubbly}></img>
            <br></br>
            <br></br>
            <br></br>
