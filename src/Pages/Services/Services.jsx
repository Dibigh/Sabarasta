     ...
     <>
      ...
      {/* <span id = {styles.starDoodle}>
        ...
        <div className = {styles.Container}>
          ...
          <div id={styles.item6}> <img src={Qa} alt='EGovernance'/><div><h3>Brand Identity Design</h3><p>Ensure the highest standards with our Quality Assurance services. We conduct thorough testing to identify and resolve issues before they impact users, guaranteeing your products are reliable, efficient, and market-ready.</p><button>Read More</button></div></div>
          <div id={styles.item7}> <img src={SS} alt='NGO'/><div><h3>SEO</h3><p>Secure your business with our advanced security services. From threat detection to robust defense strategies, we safeguard your data and IT infrastructure, ensuring protection against security threats.</p><button>Read More</button></div></div>
