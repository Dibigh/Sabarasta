...
function buttonPressed()
    ...
    <div className={styles.bodyContainer}>
        ...
        <h1>Search Engine<span className={styles.UnderlineText}> Optimization<img className={styles.underLine} src={greenLine} alt='GreenLine'/></span></h1>
        <div className = {styles.introText}>
            <p>Boost Your Visibility and Drive Traffic with Expert SEO Strategies</p>
            <p>In the competitive digital landscape, search engine optimization is key to attracting and converting customers. Sabrasta offers tailored</p>   
            <p>SEO services that enhance your online presence, improve rankings, and drive organic traffic to fuel sustainable business growth.</p><img src={bubbles} className={styles.bubbly}></img>
            <br></br>
            <br></br>
            <br></br>
            <div className={styles.BestText}>
            <p>Get the best <span>SEO</span> service for your business.</p>
            <br></br>
            <br></br>
            </div>
        </div>
