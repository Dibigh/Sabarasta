...
import greenLine from '../../../Logo/Purple.svg';
...
function buttonPressed()
    ...
    <div className={styles.bodyContainer}>
        ...
        <h1>Market <span className={styles.UnderlineText}>Research<img className={styles.underLine} src={greenLine} alt='GreenLine'/></span></h1>
        <div className = {styles.introText}>
            <p>Unlock Strategic Insights with Comprehensive Market Research</p>
            <p>Understanding your market is critical to making informed decisions and staying competitive. Sabrasta delivers in-depth market research,</p>   
            <p>providing actionable insights on consumer behavior, industry trends, and opportunities to help your business thrive</p><img src={bubbles} className={styles.bubbly}></img>
            <br></br>
            <br></br>
            <br></br>
            <div className={styles.BestText}>
            <p>Get the best <span>Market Research</span> service for your business.</p>
            <br></br>
            <br></br>
            </div>
        </div>
