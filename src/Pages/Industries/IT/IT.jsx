...
return (
    ...
    <div className={styles.bodyContainer}>
        ...
        <div id={styles.orangeContainer}><h2>Innovative Digital</h2><h2>Transformation</h2><br></br><br></br><p>Stay ahead in the digital age with transformative technologies. We help organizations modernize their IT infrastructure, embracing cloud solutions, automation, and AI to drive operational efficiency and business growth.</p></div>
        <div id={styles.greenContainer}><h2>CyberSecurity &</h2><h2>Data</h2><br></br><br></br><p>Safeguard your business with robust cybersecurity strategies. From threat detection to data encryption, we ensure your systems are secure, protecting critical information and ensuring compliance with industry regulations.</p></div> 
        <div id={styles.blueContainer}><h2>Scalability &</h2><h2>Integration</h2><br></br><br></br><p>Achieve seamless growth with scalable IT solutions. Our expertise in system integration allows businesses to efficiently expand their operations, connecting disparate systems and optimizing workflows for enhanced performance.</p></div></div>
