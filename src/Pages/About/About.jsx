  ...
  return (
    <>
       <div className={styles.bodyContainer}>
        ...
        <p>Get to know us behind the vision and the values that drive our commitment to excellence every day.</p>
        ...
        <div className={styles.Board}>
          ...
          <div id={styles.Boxes1}><img src={profile}></img><div className={styles.ProfileText}><p>Prabhat Kumar Chaudary</p><span>UX/UI Designer</span><div className={styles.LogoText}>Worem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis.</div></div><div className = {styles.Icons}><img src={social}></img></div></div>
          <div id={styles.Boxes2}><img src={profile}></img><div className={styles.ProfileText}><p>Dibigh Rai</p><span>Front-end Developer</span><div className={styles.LogoText}>Worem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis.</div></div><div className = {styles.Icons}><img src={social}></img></div></div>
          <div id={styles.Boxes3}><img src={profile}></img><div className={styles.ProfileText}><p>Biplov Paneru</p><span>Security Researcher</span><div className={styles.LogoText}>Worem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis.</div></div><div className = {styles.Icons}><img src={social}></img></div></div>
          <div id={styles.Boxes4}><img src={profile}></img><div className={styles.ProfileText}><p>Santosh Kumar Chaudhary</p><span>Software Engineer</span><div className={styles.LogoText}>Worem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis.</div></div><div className = {styles.Icons}><img src={social}></img></div></div>
          <div id={styles.Boxes5}><img src={profile}></img><div className={styles.ProfileText}><p>Dipesh Bohara</p><span>Media Manager</span><div className={styles.LogoText}>Worem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis.</div></div><div className = {styles.Icons}><img src={social}></img></div></div>
          <div id={styles.Boxes6}><img src={profile}></img><div className={styles.ProfileText}><p>Rajiv Kumar Yadav</p><span>Flutter Developer</span><div className={styles.LogoText}>Worem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis.</div></div><div className = {styles.Icons}><img src={social}></img></div></div>
         </div>
         </div>
        </div>
        </>
